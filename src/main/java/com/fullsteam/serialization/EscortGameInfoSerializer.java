...
public class EscortGameInfoSerializer extends JsonSerializer<EscortGameInfo> {

    @Override
    public void serialize(EscortGameInfo info, JsonGenerator gen, SerializerProvider serializers) throws IOException {
