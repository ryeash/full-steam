...
public class Config {
    ...
    public static final double BASE_STRAFE_CHANCE = getDouble("ai.base_strafe_chance", 0.4);
    ...
    public static final double ZOMBIE_SPEED = getDouble("game.zombie_speed", 1.9); // Slower than players
    ...
    public static final boolean ROTATE_GAME_MODES = getBool("game.rotate_game_modes", true);
